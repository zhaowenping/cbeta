...
9. 支持简体阅读和简体搜索
10. 集成康熙字典、说文解字、宋本广韵共28193字，可在线查字典, 目前只集成了大正藏用字的部分字典，如果发现查询不到的字请电邮我，以便补充。使用Levenshtein算法查询词典
...
| 词典                  | 文件名                       | 词条数量| 
| --------------------- |:----------------------------:| -------:| 
| 佛學常見詞彙（陳義孝）| cxy.json                     |  1      |
| 丁福保佛学大辞典      | dfb.json.gz                  |  1.0    |
| 佛光大辞典            | fk.json.gz                   |  1      |
| 康熙字典              | kangxi.json.gz               |  1.0    |
| 规范字                | norm.json                    |  1.0    |
| 南山律学词典          | nsl.json                     |  1.0    |
| 威廉梵英词典          | sa-en.json.gz                |         |
| 15部巴利语词典        | pali-hant.json.gz            |         |
| 三藏法数              | szfs.json                    |         |
| Yates梵英词典         | yat.json.gz                  |         |
|                       | 于凌波唯识名词白话新解.json  |         |
|                       | 庄春江汉译阿含经词典ver4.json|         |
