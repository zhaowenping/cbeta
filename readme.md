...
5. 梵文悉曇体完全使用unicode10.0标准显示, 搜索; 对悉昙字母标注了罗马形式
...
## 与cbeta阅读器的差异
1. 快如闪电! 稳如磐石!
2. 全面支持unicode 13.0. 使用unicode显示悉昙字. 使用: https://en.wikipedia.org/wiki/Siddha%E1%B9%83_script
3. 使用unicode13.0显示异体字，尽可能的使用接近藏经原貌的字; 不使用兼容字。(部分汉字使用了G区汉字)
