...
2. 汉字处理区分为原版和阅读版。
   1. 正字法版本: 完全去除异体字和通假字。方便快速、无歧义阅读和搜索。
   2. 原版: 使用UNICODE 13.0版本; 在此基础上尽力显示经文原貌, 使用藏经原有字形, 补全cbeta缺失的生僻字. 恢复部分异体字在藏经中的原貌
...
5. 梵文悉曇体、兰扎体完全使用unicode13.0标准显示, 搜索; 对悉昙字母和兰扎字母标注了罗马注音
6. 对计算机友好的完全开放的接口, url支持命令行操作, 支持多种输出形式:xml, json, pdf, html, epub, docx, mp3...
7. 拼音标注, 语音合成，自动朗读


## 目标
1. 标准。完全使用符合国际标准的技术来实现。诸如unicode13.0,html5... 可以在几乎任何操作系统、浏览器上或者完全一致的体验。
2. 专业。尽力还原古籍原貌，不做妥协。
...
3. 使用unicode13.0显示异体字，尽可能的使用接近藏经原貌的字; 不使用兼容字。(包括A、B、C、D、E、F、G区汉字)
...
9. 无上士调御丈夫 中间的标点去掉
10. 校勘了大约数十万处原文错误的字词，相比cbeta变动超过120~200万处(数量是大概统计)
...
## 设备兼容性
1. 已经测试过的设备列表: X86 PC、苹果、苹果手机、ipad、华为手机部分型号、文石note2、诺基亚N9
...
本程序编写过程中得到了如下机构和个人的无私支持和帮助，表示衷心感谢！
...
7. 苏长涛先生 制作G区汉字的字体、制作兰扎体梵文字体、制作生僻字汉字字库(以上均为UNICODE 13.0标准版本)
8. 可善先生 为香港DEMO提供了一个新家
9. 释慧航法师 校勘丁福保《佛學大辭典》多处错误
10. 赵宇老师 提供金藏等多种校勘原始文本，提供校订用生僻字、异体字论文、字典、词典数十本
11. 蒋劲松老师 提供多处修改建议
12. 杨新宇博士 提供异译本对照目录
13. 大众阅藏网 提供经文朗读音频
14. 安得剑先生 校订了多音字发音表
15. 贤超法师 提供了AI智能标点程序，在多处辞典中使用
16. 崔文治博士 校订了悉檀梵文
17. 悟修法师 提供了正字法校勘表
18. 比丘尼道葦 提供了多处异体字修正
