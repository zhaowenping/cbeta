...
## 哲学或者主旨
1. 这些代码只是我自己用的，为了自己用的舒服，开放出来也只是基于共享精神
2. 版权问题：这些代码都是完全公开的，没有版权，以后考虑加入MIT或者公共域等其他类似的版权，你可以拿去完全的修改，公开发行，去掉我的名字，融资上市挣钱，这些我都不关心
3. 任何导致作者有可能不能使用自己的代码的行为都是禁止的。我在任何情况下都完全拥有使用自己代码的权力，所有权、著作权，修改权，无论你怎么修改这些代码。
4. 免责声明：因为没有版权，所以如果出了什么事情，把你的电脑搞砸了，或者破坏了世界和平，毁灭了宇宙，都跟我一点关系都没有，不要来找我！
5. 你把这些拿去使用不会有任何法律上烦恼，因为采用的一切技术都是free的技术，不需要你购买开发工具，不需要你购买操作系统，不需要你购买数据库 
6. 因为这是自由软件，但是不是免费软件，所以此资源完全可以通过商业途径传播，可以高价、天价或者宇宙价出售光盘/U盘/软盘, 可以随有价光盘/U盘一起赠送！这些不需要本人的任何授权！也不需要通知本人。
