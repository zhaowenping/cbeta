...
## 浏览器兼容性
1. firefox、opera、chrome、safari等主流浏览器都没有发现任何问题；手机上浏览打开的时候会有卡顿，跟手机的CPU速度有关
2. 搜狗浏览器目前无法翻页,上一卷,下一卷链接无法打开
3. ie8仅仅是输入网址就直接卡死，根据资料，IE9应该可以显示文字；Edge只能显示文字, 没有css效果
4. links2乱码，w3m只显示xml结构。lynx应该是无法使用
